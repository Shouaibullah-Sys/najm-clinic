...
import { IPrescription, PrescriptionItem } from "@/lib/models/Order.ts";
                ...
                {prescription.items.map(
                  (item: PrescriptionItem, index: number) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="grid grid-cols-1 md:grid-cols-6 gap-2 text-xs sm:text-sm py-2 border-t"
                      >
